    ...
    const features = [
        {
            ...
            link: '/smart-adoption', // This link exists
        ...
        },
        {
            ...
            link: '/digital-twin', // Added placeholder link
        ...
        },
        {
            ...
            link: '/ai-forecaster', // Added placeholder link
        ...
        },
        {
            ...
            link: '/trust-safety', // Added placeholder link
        ...
        },
        {
            ...
            link: '/collaborate', // Added placeholder link
            ...
            <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
                ...
                <div className="grid grid-cols-1 mt-8 text-center sm:mt-10 sm:grid-cols-2 sm:gap-x-8 gap-y-8 md:grid-cols-3 md:gap-0">
                    ...
                    {features.map((feature, index) => (
                        <div
                            key={index}
                            // FIXED: Check if link exists, then navigate
                            onClick={() => feature.link && navigate(feature.link)}
                            
                            // ADDED: cursor-pointer only if link exists
